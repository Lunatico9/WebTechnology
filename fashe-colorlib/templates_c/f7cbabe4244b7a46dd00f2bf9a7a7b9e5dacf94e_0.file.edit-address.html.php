<?php
/* Smarty version 3.1.33, created on 2019-02-16 18:27:09
  from 'C:\wamp64\www\edit-address.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c6855fdaa28e8_86124282',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f7cbabe4244b7a46dd00f2bf9a7a7b9e5dacf94e' => 
    array (
      0 => 'C:\\wamp64\\www\\edit-address.html',
      1 => 1550340341,
      2 => 'file',
    ),
  ),
...
function content_5c6855fdaa28e8_86124282 (Smarty_Internal_Template $_smarty_tpl) {
			...
			<div class="col-6">
				<form method="POST" action="edit-address.php">
					...
					<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="address-name" value="<?php echo $_smarty_tpl->tpl_vars['alias']->value;?>
" required>
					</div>
					
					<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="name" value="<?php echo $_smarty_tpl->tpl_vars['name']->value;?>
" required>
					</div>

					<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="surname" value="<?php echo $_smarty_tpl->tpl_vars['surname']->value;?>
" required>
					</div>
					
					<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="address" value="<?php echo $_smarty_tpl->tpl_vars['address']->value;?>
" required>
					</div>

					<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="number" name="civ" value="<?php echo $_smarty_tpl->tpl_vars['civ']->value;?>
" required>
					</div>

					<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="city" value="<?php echo $_smarty_tpl->tpl_vars['city']->value;?>
" required>
					</div>

					<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="region" value="<?php echo $_smarty_tpl->tpl_vars['region']->value;?>
" required>
					</div>

					<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="number" name="cap" value="<?php echo $_smarty_tpl->tpl_vars['cap']->value;?>
" required>
					</div>

					<div class="bo4 of-hidden size15 m-b-20">
						<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="country" value="<?php echo $_smarty_tpl->tpl_vars['country']->value;?>
" required>
					</div>
