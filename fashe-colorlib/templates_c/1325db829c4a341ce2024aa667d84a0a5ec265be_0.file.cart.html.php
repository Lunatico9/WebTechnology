<?php
/* Smarty version 3.1.33, created on 2019-02-17 17:55:43
  from 'C:\wamp64\www\fashe-colorlib\cart.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c69a01f0d5133_28051223',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1325db829c4a341ce2024aa667d84a0a5ec265be' => 
    array (
      0 => 'C:\\wamp64\\www\\fashe-colorlib\\cart.html',
      1 => 1550426140,
      2 => 'file',
    ),
  ),
...
function content_5c69a01f0d5133_28051223 (Smarty_Internal_Template $_smarty_tpl) {
...
">
							...
							<td class="column-3-row">€ <?php echo $_smarty_tpl->tpl_vars['product']->value[4];?>
</td>
							<?php } else { ?>
							<td class="column-3-row">€ <?php echo $_smarty_tpl->tpl_vars['product']->value[1];?>
</td>
							<?php }?>
							<td class="column-4">
								<div class="flex-w bo5 of-hidden w-size17">
									...
									<input class="size8 m-text18 t-center num-product" type="number" name="num-product1" id="quantity" min="0" value="<?php echo $_smarty_tpl->tpl_vars['product']->value[3];?>
">
...
<!--===============================================================================================-->
    <?php echo '<script'; ?>
 type="text/javascript">
        var price = $(".column-3-row").text();
        var quantity = $("#quantity").val();
        price = (price.slice(2) * quantity).toString();
        price = price.slice(0, price.indexOf(".") + 3);
        $(".column-5-row").append("€ "+ price);
    <?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 type="text/javascript">
