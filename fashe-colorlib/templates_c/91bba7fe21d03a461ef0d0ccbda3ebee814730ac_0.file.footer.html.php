<?php
/* Smarty version 3.1.33, created on 2019-02-15 20:55:35
  from 'C:\wamp64\www\footer.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c672747957f61_14957616',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '91bba7fe21d03a461ef0d0ccbda3ebee814730ac' => 
    array (
      0 => 'C:\\wamp64\\www\\footer.html',
      1 => 1550264096,
      2 => 'file',
    ),
  ),
...
function content_5c672747957f61_14957616 (Smarty_Internal_Template $_smarty_tpl) {
?><footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
    <div class="flex-w p-b-90">
        <div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
            ...
            <div>
                <p class="s-text7 w-size27">
                    Any questions? Contact us or call us on (+39)39934768
                </p>
        ...
        <div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
            ...
            <ul>
                <li class="p-b-9">
                    <a href="shop.php?catalogue=swords" class="s-text7">
                        Swords
                    </a>
                </li>

                <li class="p-b-9">
                    <a href="shop.php?catalogue=shields" class="s-text7">
                        Shields
                    </a>
                </li>

                <li class="p-b-9">
                    <a href="shop.php?catalogue=protective gears" class="s-text7">
                        Protective Gears
                    </a>
                </li>

                <li class="p-b-9">
                    <a href="shop.php?catalogue=manuscripts" class="s-text7">
                        Manuscripts
                    </a>
                </li>
            </ul>
